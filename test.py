...
def test_model_accuracy():
    ...
    expected_accuracy = 0.8  # Example threshold of 80% accuracy
    print(f"Model Accuracy: {accuracy * 100:.2f}%")
    
    # Use pytest assertions to verify if the model's accuracy is above the expected threshold
    assert accuracy >= expected_accuracy, f"Model accuracy {accuracy * 100:.2f}% is below the threshold"
